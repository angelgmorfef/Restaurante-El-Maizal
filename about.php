...
<head>
    ...
    <meta name="description" content="Nuestra historia. Conoce cómo El Maizal se convirtió en un rincón donde la comida une y la tradición vive.">
    <title>Acerca de - El Maizal</title>
        ...
        <div class="aboutContainer">
            <div class="aboutWrapper">
                <div class="aboutImages">
                    <div class="aboutImage firstAboutImage">
                        <img src="asset/img/about-1.jpg" alt="Preparación de nuestros platos" />
                    </div>
                    <div class="aboutImage">
                        <img src="asset/img/about-2.jpg" alt="Ingredientes frescos" />
                    </div>
                    <div class="aboutImage">
                        <img src="asset/img/about-3.jpg" alt="Restaurante" />
                    </div>
                </div>
                <div class="aboutTextRight">
                    <h1 id="welcomeHeader">Bienvenido a El Maizal</h1>
                    <p>
                        En El Maizal, cocinamos con alma y servimos con corazón. Nacimos para rendir homenaje a nuestras raíces, transformando ingredientes tradicionales en experiencias que despiertan los sentidos. Cada plato que sale de nuestra cocina lleva la esencia de lo local y el sabor auténtico de lo hecho en casa.
                    </p>
                    <p>
                        Fundado por Dalvis Maiz, un apasionado de la gastronomía con visión de futuro, El Maizal no es solo un restaurante: es un rincón donde la comida une, la tradición vive y cada visita se convierte en un recuerdo. Bienvenido al sabor de lo nuestro.
                    </p>
                </div>
            </div>
        </div>
